...
import { ArrowLeft, Lightbulb, Plus, Car } from "lucide-react"
import HeaderSimple from "@/components/header-simple"
import Footer from "@/components/footer"
import AnimatedFadeIn from "@/components/animated-fade-in"
import { PhoneInput } from "@/components/phone-input"

export default function VtcLoaPage() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-64 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-4xl font-bold mb-4">Crédit-Bail Professionnel pour VTC</h1>
          <p className="text-lg">
            <span>Accueil</span> / VTC / LOA
          </p>
        </div>
      </section>
                ...
                <Card className="bg-white shadow-md h-full">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-gray-700">
                      La LOA est un contrat de location qui vous donne, dès la signature, la promesse de pouvoir
                      acheter le véhicule en fin de contrat. Les loyers intègrent l'amortissement du véhicule.
                    </p>
                  </CardContent>
                </Card>
              </AnimatedFadeIn>
              ...
              <AnimatedFadeIn delay={0.4}>
                <Card className="bg-white shadow-md h-full">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-gray-700">
                      Flexibilité maximale : Vous pouvez ajuster le montant du dernier loyer (valeur résiduelle) pour
                      maîtriser vos mensualités. Devenez propriétaire : C'est la solution idéale si vous avez la
                      certitude de vouloir acheter le véhicule à terme.
                    </p>
                  </CardContent>
                </Card>
              </AnimatedFadeIn>
              ...
              <AnimatedFadeIn delay={0.6}>
                <Card className="bg-white shadow-md h-full">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-gray-700">
                      Vous levez obligatoirement l'option d'achat pour acquérir le véhicule, ou vous le restituez (si
                      la clause de restitution est prévue).
                    </p>
                  </CardContent>
                </Card>
              </AnimatedFadeIn>
