...
export default function VtcLldPage() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-64 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-4xl font-bold mb-4">Financement VTC LLD</h1>
          <p className="text-lg">
            <span>Accueil</span> / VTC / LLD
          </p>
        </div>
      </section>
          ...
          <div className="mb-16">
            <AnimatedFadeIn>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 text-center uppercase">
                LA LOCATION LONGUE DURÉE (LLD) AVEC OPTION D'ACHAT
              </h2>
                ...
                <Card className="bg-white shadow-md h-full">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-gray-700">
                      La LLD est une formule de financement qui permet de louer un véhicule sur une longue période, avec
              ...
              <AnimatedFadeIn delay={0.4}>
                <Card className="bg-white shadow-md h-full">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-gray-700">
                      Pas d'immobilisation de capital, véhicule toujours récent, entretien inclus et possibilité d'achat
                      à prix avantageux.
                    </p>
                  </CardContent>
                </Card>
              ...
              <AnimatedFadeIn delay={0.6}>
                <Card className="bg-white shadow-md h-full">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-gray-700">
                      Un véhicule performant et fiable, avec une solution de financement flexible adaptée à votre
                      activité de chauffeur VTC.
                    </p>
                  </CardContent>
                </Card>
              </AnimatedFadeIn>
